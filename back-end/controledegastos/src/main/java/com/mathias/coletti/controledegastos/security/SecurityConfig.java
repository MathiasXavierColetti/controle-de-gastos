...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                // Habilita o CORS usando o bean corsConfigurationSource() definido abaixo
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // LIBERA A ROTA DE ERRO INTERNO DO SPRING (Essencial para não quebrar o CORS em exceções)
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Aceita qualquer porta vinda de localhost ou 127.0.0.1
